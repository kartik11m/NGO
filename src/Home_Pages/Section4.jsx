...
const Section4 = () => {
  return (
    <div className='container mx-auto px-6 py-6 mt-10'>
        ...
        <div className='grid grid-cols-3 gap-4 relative max-sm:grid-rows-3 max-sm:grid-cols-1 mt-10'>
            <div className="relative bg-[url(/images/grid1.png)] bg-center bg-cover rounded-xl h-80 px-4 max-lg:h-full">
                <div className='flex flex-col gap-10 max-md:gap-4 items-center mt-10'>
            ...
            <div className="relative bg-[url(/images/grid2.png)] bg-center bg-cover rounded-xl h-80 px-4 max-lg:h-full">
                <div className='flex flex-col gap-10 max-md:gap-4 items-center mt-10'>
            ...
            <div className="relative bg-[url(/images/grid3.png)] bg-center bg-cover rounded-xl h-80 px-4 max-lg:h-full">
                <div className='flex flex-col gap-10 max-md:gap-4 max-xl:gap-6 items-center mt-10'>
